    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap14">
                ...
                <div>
                    <div class="body-text mb-2">Total Utilisateur</div>
                    <h4>{{$totalUsers}}</h4>
                </div>
            </div>
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap14">
                ...
                <div>
                    <div class="body-text mb-2">Total Évènement</div>
                    <h4>{{$totalEvents}}</h4>
                </div>
            </div>
        </div>
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap14">
                ...
                <div>
                    <div class="body-text mb-2">Totale Commande</div>
                    <h4>{{$totalOrders}}</h4>
                </div>
            </div>
        </div>
    ...
    <div class="wg-chart-default">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap14">
                ...
                <div>
                    <div class="body-text mb-2">Total Revenu</div>
                    <h4>{{$totalRevenue}} FCFA</h4>
                </div>
            </div>
        </div>
        <div class="wrap-chart">
...
<div class="mb-30">
    <div class="wg-box">
        <div class="row">
            <div>
                <h5 class="mb-16">Fluctuation des Utilisateurs et des Evénements</h5>
                <div class="wrap-chart">
